...
export const Dashboard = () => {
  const { balance, income, expense, prevIncome, prevExpense, dailyBudget, transactions, currentMonthDate, changeMonth, activeAccount } = useExpenses();
    ...
    <div className="dashboard-container">
      ...
      <div className="glass-panel summary-card daily-budget-card">
        ...
        <div className="summary-info">
          ...
          <p>{formatCurrency(dailyBudget, currency)} <span>/día</span></p>
        </div>
      </div>
